    ...
    return (
        <div className="flex flex-col">
            <main className="flex-1">
                ...
                <div className="container px-4 md:px-14 lg:px-58 mx-auto pt-4 md:pt-8 lg:pt-12 pb-10">
                    <div className="flex flex-col md:flex-row lg:flex-row items-center md:items-start space-y-14 md:space-y-0 md:space-x-6">
                        {/*Info a la izq*/} 
                        <div className="md:w-1/2 flex flex-col items-center md:items-start">
                            <h1 className="text-2xl md:text-2xl lg:text-4xl font-semi-bold tracking-tighter text-black text-clip mb-4 md:mb-2 lg:mb-4">
                                ¿Quiénes Somos?
                            </h1>
                            <p className="text-2x1 md:text-base lg:text-xl text-gray-500 font-medium text-clip px-12 md:px-0">
                ...
                <div className="w-full px-20 md:px-4 lg:px-38 mx-auto bg-blue-900 pt-14 pb-10">
                    <div className="flex flex-col md:flex-row items-center md:items-start justify-between text-center text-white md:gap-x-12">
                        ...
                        <img 
                                ...
                                <p className="about-desc-text"><strong>Compromiso:</strong> Entregas puntuales y responsables.</p>
                                <p className="about-desc-text"><strong>Transparencia:</strong> Comunicación clara en cada envío.</p>
                                <p className="about-desc-text"><strong>Calidad:</strong> Atención personalizada y eficiente.</p>
                                <p className="about-desc-text"><strong>Empatía:</strong> Tratamos cada paquete con cuidado y respeto.</p>
